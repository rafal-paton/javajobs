package com.javajobs.features;

import com.fasterxml.jackson.core.type.TypeReference;
import com.github.tomakehurst.wiremock.client.WireMock;
import com.javajobs.BaseIntegrationTest;
import com.javajobs.SampleJobOfferResponse;
import com.javajobs.domain.offer.dto.OfferResponseDto;
import com.javajobs.infrastructure.offer.scheduler.HttpOffersScheduler;
...
public class TypicalScenarioUserWantToSeeOffersIntegrationTest extends BaseIntegrationTest implements SampleJobOfferResponse {
    ...
    public void user_want_to_see_offers_but_have_to_be_logged_in_and_external_server_should_have_some_offers() throws Exception {
        ...
        String jsonWithOffers = result.getResponse().getContentAsString();
        ...
        //step 9: scheduler ran 2nd time and made GET to external server and system added 2 new offers to database
        // given & when
        ...
        // given
        String notExistingOfferUrl = "/offers/9999";
        // when
        ResultActions performGetOffersNotExistingId = mockMvc.perform(get(notExistingOfferUrl)
                .contentType(MediaType.APPLICATION_JSON_VALUE));
        // then
        ...
        //step 12: user made GET /offers/{id} and system returned OK(200) with offer
        // given
        ...
        //step 14: scheduler ran 3rd time and made GET to external server and system added 2 new offers to database
        // given && when
        ...
        //step 15: user made GET /offers with header “Authorization: Bearer AAAA.BBBB.CCC” and system returned OK(200) with 4 offers
        // given && when
