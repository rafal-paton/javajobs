package com.javajobs.scheduler;

import com.javajobs.BaseIntegrationTest;
import com.javajobs.JavaJobsApplication;
...
@SpringBootTest(classes = JavaJobsApplication.class, properties = "scheduling.enabled=true")
